    ...
    cy.get(this.logoutButton)
      ...
      .then((buttonName) => {
        if (buttonName.trim() === 'LogOut') {
          ...
          cy.get(this.shippingAndWarrantySectionTitle).should('be.visible');
          cy.get(this.shippingDetailText).should('be.visible');
          cy.get(this.warrantyDetailText).should('be.visible');
